...
parse_target_line() {
  local line="$1"
  IFS=$'\t' read -r TARGET_NAME TARGET_RUNNER TARGET_NODE_ID TARGET_ROLE TARGET_GROUP_ID TARGET_HTTP_ADDR TARGET_RAFT_ADDR TARGET_BOOTSTRAP TARGET_REJOIN TARGET_JOIN_ADDR TARGET_ETCD TARGET_HEALTH_URL TARGET_RAFT_DIR TARGET_DB_PATH TARGET_LOG_PATH <<< "$line"
